...
Las tres bases comparten la misma estructura de variables y cada fila corresponde a un evento de protesta distinto. 
Para el detalle de las variables, los valores y criterios de codificación, consulta el libro de códigos.
